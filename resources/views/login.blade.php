...
<body class="bg-gray-100 ">
    ...
    <div class="flex justify-center mt-[50px] ">
        <div class="grid grid-cols-[1fr_2fr] bg-white w-4xl rounded-lg mt-8 border border-gray-300 shadow-xl">
            <div class="border-l border-gray-300 flex items-center mr-4  ">
            ...
            <div>
                ...
                <div class="flex flex-col mt-6 ">
                    ...
                    <h1 class="text-bold font-serif  text-3xl  text-center ">تسجيل الدخول</h1>
                    <p class="text-[#558F67]  font-serif text-lg text-center">اهلا بعودتك</p>
                    ...
                    <form action="{{ route('storeLogin') }}" method="POST">
                        ...
                        <x-floatingLabelInput id="phoneNumber" type="text" name="phoneNumber" labelValue="رقم الهاتف"
                            icon="fa-solid fa-phone-flip" />
                        <x-floatingLabelInput id="password" type="password" name="password" labelValue="الرقم السري"
                        ...
                        <div class="mt-5 flex justify-center mb-6">
                            <x-link-nav class="text-sm" icon="fa-solid fa-unlock" href="{{ route('forgetPassword') }}">
                                نسيت كلمة المرور</x-link-nav>
                        </div>
