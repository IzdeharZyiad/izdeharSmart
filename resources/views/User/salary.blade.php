        ...
        <div class=" mt-4 h-[40px]  ">
            <div class="grid grid-cols-[0.5fr_1fr] h-full">
                ...
                <div class="flex items-center mr-2">
                    <h1 class="text-green-900 text-sm font-medium">الراتب</h1>
                </div>

                <div class="flex justify-end   ml-2 ">
                    <livewire:salary.salary-form :user_id="$user->id" :cycle_id="$cycle->id" />
                </div>
            ...
            <div class="flex-1 flex flex-col overflow-y-auto custom-scroll ">
                ...
                <table id="myTable">
                    ...
                    <tbody>
                        ...
                        @foreach ($salaryes as $salarye)
                            <tr>
                                <td>{{ $salarye->date }}</td>
                                <td>{{ $salarye->dayName }}</td>
                                <td>{{ $salarye->mount }}</td>
                                <td></td>
                            </tr>
                        @endforeach
