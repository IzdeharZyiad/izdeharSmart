...
@section('navbar-row')
    <div class=" flex flex-col justify-center md:hidden">
        ...
        <div class="flex mr-2 space-x-3 ">
            ...
            <x-link-nav :href="route('sales.saleDetails', ['saleId' => $sale->id])" :active="request()->routeIs('sales.saleDetails', ['saleId' => $sale->id])" icon="fa-solid fa-truck">العملية</x-link-nav>
        ...
        <div class="flex-1 flex flex-col  overflow-y-auto custom-scroll md:items-center">
            <div class=" md:w-lg  lg:w-3xl">
                <form action="{{ route('sales.saleDetails.storeSaleDetails') }}" method="POST">
                    ...
                    <livewire:sale.sale-form :types="$types" />
