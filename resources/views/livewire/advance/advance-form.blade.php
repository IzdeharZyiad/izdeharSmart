<div>
    ...
    <button wire:click="openModal"
        ...
        <span class="hidden md:block mr-2">اضافة سلفة</span>
    </button>


    @if ($open)
        <div class="fixed inset-1 z-[1550]  mt-20 max-w-sm h-70 md:max-w-lg lg:max-w-xl md:mr-40 lg:mr-90">
            <div class="w-full    bg-white border border-green-600 shadow-xl shadow-gray-700/50   flex  flex-col ">
                ...
                <div class="flex-1 mt-2">
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <x-floatingLabelInput wire:model="remain" id="remain" name="remain"
                            icon="fa-solid fa-money-bill" labelValue="المتبقي من الراتب" readonly />
