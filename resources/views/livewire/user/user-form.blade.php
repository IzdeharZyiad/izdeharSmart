<div>
    <button wire:click="openModal"
        ...
        <span class="hidden md:block mr-2">اضافة موظف</span>
    </button>
            ...
            <div
                ...
                <div class="flex-1 mt-2">
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <x-floatingLabelInput wire:model="name" id="" name="name" labelValue="اسم الموظف" />
                        ...
                        <div class=" mt-5 m-auto relative flex flex-col " dir="rtl">
                            <select
                                ...
                                name="salary_type" wire:model="salary_type">
                                <option value="">الرجاء اختيار طبيعة الراتب</option>
                        ...
                        <x-floatingLabelInput wire:model="salary_amount" id="" name="salary_amount"
                            labelValue="المبلغ" icon="fa-solid fa-money" />


                        <x-floatingLabelInput type="date" id="dateToday" name="dateToday" wire:model="dateToday"
                            value="{{ $dateToday }}" labelValue="تاريخ الانضمام" icon="fa-solid fa-calendar" />
