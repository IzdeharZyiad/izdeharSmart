<div>
    ...
    <button wire:click="openModal"
        ...
        <span class="hidden md:block mr-2">اضافة منتج</span>
    </button>
    ...
    @if ($open)
        <div class="fixed inset-1 z-[1550]  mt-40 max-w-sm h-70 md:max-w-lg lg:max-w-xl md:mr-40 lg:mr-90">
            <div
                class="w-full  bg-red-500  bg-white border border-green-600 shadow-xl shadow-gray-700/50   flex  flex-col ">
                ...
                <div class="flex-1 mt-2">
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <x-floatingLabelInput wire:model="name" id="" name="name" labelValue="اسم المنتج" />


                        <x-floatingLabelInput type="file" wire:model="productImg" id="productImg" name="productImg"
                            labelValue="صورة المنتج" icon="fa-solid fa-file-image" />
