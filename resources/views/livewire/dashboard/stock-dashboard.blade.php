     ...
     <div class="flex-1 h-full flex flex-col  mt-4 border-t border-gray-200  overflow-y-auto custom-scroll">
         ...
         <div class="flex flex-col md:grid grid-cols-3 md:h-25">
             <div class="border-b md:border-l  border-gray-200">
                 <x-card-nav icon="fa-solid fa-hashtag" text="عدد المنتجات" value="{{ $ProductCount }}" />
             </div>
             <div class="border-b  md:border-l border-gray-200">
                 <x-card-nav icon="fa-solid fa-hashtag" text="إجمالي الكميات" value="{{ $ProductQuantity }}" />
             </div>
             <div class="border-b md:border-l  border-gray-200">
                 <x-card-nav icon="fa-solid fa-hashtag" text="اعلى منتج توافرا" value="{{ $maxProduct }}" />
             </div>
