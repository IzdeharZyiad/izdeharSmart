...
@php
    $classes =
        $active ?? false
            ...
            : ' group border-green-800 text-green-900 hover:bg-green-800  hover:p-2 
            hover:cursor-pointer hover:rounded-lg hover:text-white';

    $span_class =
        $active ?? false
            ? 'hidden md:inline-block md:px-2 '
            : 'hidden md:inline-block   group-hover:inline  rounded-lg   px-2';
